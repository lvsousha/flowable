...
//    apply(processEngine, "仲裁员助理Id");
    assistantAudit(processEngine, "17504");
//    leaderSendBack(processEngine, "5003");
  ...
  public void getTaskUser(ProcessEngine processEngine, String userId) {
    ...
    for (int i=0; i<tasks.size(); i++) {
      ...
      System.out.println((i+1) + ") " + task.getName()+"=="+task.getAssignee()+"=="+task.getOwner());
    }
  }
  ...
  public ProcessEngine init() {
    ProcessEngineConfiguration cfg = new StandaloneProcessEngineConfiguration()
        .setJdbcUrl("jdbc:mysql://localhost:3306/flowable?useUnicode=yes&characterEncoding=UTF-8&useSSL=true")
